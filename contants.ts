...
export const STATES_AND_DISTRICTS: StateData[] = [
  {
    ...
    subDistricts: {
      "Anantapur": ["Anantapur", "Bathalapalli", "Beluguppa", "Bommanahal", "Brahmasamudram", "Bukkarayasamudram", "Chenne Kothapalli", "D.Hirehal", "Dharmavaram"],
      "Chittoor": ["Chittoor", "Gudipala", "Irala", "Penumuru", "Puthalapattu", "Ramapuram", "Tavanampalle", "Yadamari"]
    }
  },
  {
  ...
  },
  {
    ...
    subDistricts: {
      "Pune": ["Pune City", "Haveli", "Khed", "Ambegaon", "Junar", "Shirur", "Daund", "Indapur", "Baramati", "Purandar", "Bhor", "Velhe", "Mulshi", "Maval"],
      "Nagpur": ["Nagpur Urban", "Nagpur Rural", "Kamptee", "Hingna", "Katol", "Narkhed", "Savner", "Kalameshwar", "Ramtek", "Parseoni", "Mauda", "Kuhi", "Bhiwapur", "Umred"]
    }
  },
  {
    name: "Manipur",
    districts: ["Bishnupur", "Chandel", "Churachandpur", "Imphal East", "Imphal West", "Jiribam", "Kakching", "Kamjong", "Kangpokpi", "Noney", "Pherzawl", "Senapati", "Tamenglong", "Tengnoupal", "Ukhrul"]
  },
  {
    name: "Meghalaya",
  ...
  {
    name: "Punjab",
    districts: ["Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka", "Ferozepur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", "Mansa", "Moga", "Muktsar", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar", "Sangrur", "Shahid Bhagat Singh Nagar", "Sri Muktsar Sahib", "Tarn Taran"]
  },
  {
    name: "Rajasthan",
  ...
  },
  {
    ...
    subDistricts: {
      "Haridwar": ["Haridwar", "Roorkee", "Bhagwanpur", "Laksar", "Haridwar (Rural)", "Narsan"],
      "Dehradun": ["Dehradun", "Chakrata", "Vikasnagar", "Kalsi", "Rishikesh", "Doiwala"]
    }
  },
  {
    name: "West Bengal",
